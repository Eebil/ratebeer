...
class BeerClubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer_club" do
    assert_difference("BeerClub.count") do
      post beer_clubs_url, params: { beer_club: { city: @beer_club.city, founding_year: @beer_club.founding_year, name: @beer_club.name } }
    end
  ...
  test "should update beer_club" do
    patch beer_club_url(@beer_club), params: { beer_club: { city: @beer_club.city, founding_year: @beer_club.founding_year, name: @beer_club.name } }
